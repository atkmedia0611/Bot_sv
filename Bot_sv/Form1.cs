...
namespace Bot_sv
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            string token = "6081514496:AAFoo5SLso4rEQVIJpe8WUQJD3mqjM3clfI";
            ...
            async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
            {
                ...
                else if (messLow.StartsWith("thong tin"))
                {
                    reply = " chac chan roi ";
                }
                else if (new[] { "kmt", "k56kmt", "ky thuat may tinh" }.Any(keyword => messLow.Contains(keyword)))
                {
                    reply = "Ý bạn là lớp kỹ thuật máy tính K56kmt01 khoa điện tử trường ĐHKTCN-ĐHTN  " +
                        "Có 43 sinh viên  " +
                        "lớp 56kmt mãi đỉnh ";
                }
                else if (messLow.StartsWith("thay giao"))
                {
                    reply = " đỗ duy cốp  ";
                }
        ...
        private void InitializeComponent()
        {
            ...
            // txtLog
            // 
            this.txtLog.Location = new System.Drawing.Point(85, 30);
            this.txtLog.Multiline = true;
            this.txtLog.Name = "txtLog";
            this.txtLog.Size = new System.Drawing.Size(312, 157);
